          ...
          <div>
            ...
            <div className="mt-[12px]">
              <Text className="text-white/50">
                The HAQQ Ecosystem Airdrop, a unique and innovative digital
                asset, serves as the core driving force of the HAQQ blockchain
                network, a burgeoning system that is steadily making its mark in
                the digital world. This token is not just an ordinary asset; it
